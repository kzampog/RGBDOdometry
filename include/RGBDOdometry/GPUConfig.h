...
class GPUConfig
{
    ...
    private:
           ...
           so3StepBlocks(64)
        {
            ...
            icpStepMap["Quadro 2000M"] = std::pair<int, int>(128, 16);
            rgbStepMap["Quadro 2000M"] = std::pair<int, int>(160, 16);
            rgbResMap["Quadro 2000M"] = std::pair<int, int>(160, 64);
            so3StepMap["Quadro 2000M"] = std::pair<int, int>(160, 16);
            ...
            rgbStepMap["GeForce GTX 1080"] = std::pair<int, int>(160, 80);
            rgbResMap["GeForce GTX 1080"] = std::pair<int, int>(512, 512);
            so3StepMap["GeForce GTX 1080"] = std::pair<int, int>(224, 64);
